<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="memberLevelName" header-align="center" align="center" label="Member Level Name"></el-table-column>
      ...
      >
        <template slot-scope="scope">
          <el-tag type="primary" v-if="scope.row.addOther==0">Cannot Stack</el-tag>
          <el-tag type="success" v-else>Can Stack</el-tag>
        </template>
      </el-table-column>
