<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="startTime" header-align="center" align="center" label="Daily Start Time"></el-table-column>
      <el-table-column prop="endTime" header-align="center" align="center" label="Daily End Time"></el-table-column>
      <el-table-column prop="status" header-align="center" align="center" label="Enabled Status"></el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="Actions">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="relationProduct(scope.row.id)">Associate Products</el-button>
          <br/>
    ...
    <div>
      <el-dialog
        ...
        title="Associate Flash Sale Products"
        width="60%"
      >
