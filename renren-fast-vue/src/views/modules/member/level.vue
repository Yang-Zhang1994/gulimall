<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="growthPoint" header-align="center" align="center" label="Required Growth Value"></el-table-column>
      <el-table-column prop="defaultStatus" header-align="center" align="center" label="Default Level">
        <template slot-scope="scope">
          <i class="el-icon-success" v-if="scope.row.defaultStatus==1"></i>
          <i class="el-icon-error" v-else></i>
        </template>
      </el-table-column>
      <el-table-column prop="freeFreightPoint" header-align="center" align="center" label="Free Shipping Standard"></el-table-column>
      <el-table-column
        prop="commentGrowthPoint"
        header-align="center"
        align="center"
        label="Growth Value per Evaluation"
      ></el-table-column>
      ...
      <el-table-column prop="note" header-align="center" align="center" label="Remarks"></el-table-column>
