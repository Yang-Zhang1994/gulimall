  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('order:refundinfo:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">Batch Delete</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="Refund Transaction Flow Number">
      </el-table-column>
      <el-table-column
        prop="refundStatus"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="Refund Channel [1-Alipay, 2-WeChat Pay, 3-UnionPay, 4-Bank Transfer]">
      </el-table-column>
      <el-table-column
        prop="refundContent"
        header-align="center"
