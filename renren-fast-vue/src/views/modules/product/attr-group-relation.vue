      ...
      <el-dialog width="40%" title="Select Attribute" :visible.sync="innerVisible" append-to-body>
        <div>
          ...
          >
            ...
            <el-table-column prop="valueSelect" header-align="center" align="center" label="Selectable Values"></el-table-column>
          </el-table>
          <el-pagination
      ...
      <el-row>
        <el-col :span="24">
          ...
          >
            ...
            <el-table-column prop="valueSelect" label="Selectable Values">
...
export default {
  ...
  methods: {
    ...
    submitAddRealtion() {
      ...
      //prepare data
      console.log("Data to add", this.innerdataListSelections);
      if (this.innerdataListSelections.length > 0) {
        ...
        this.$http({
          ...
          if (data.code == 0) {
            this.$message({ type: "success", message: "Add relation successful" });
          }
