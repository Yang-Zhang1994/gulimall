<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="250" label="Operations">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="updateCatelogHandle(scope.row.brandId)">Link Category</el-button>
...
export default {
  ...
  methods: {
    ...
    deleteHandle(id) {
      ...
      const msg = id
        ? `Are you sure you want to delete this brand? (ID: ${id})`
        : `Are you sure you want to delete the selected ${ids.length} brand(s)?`;
