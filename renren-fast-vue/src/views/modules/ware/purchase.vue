<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item label="Status">
        <el-select style="width:120px;" v-model="dataForm.status" placeholder="Please select status" clearable>
          ...
          <el-option label="Abnormal" :value="4"></el-option>
        </el-select>
      </el-form-item>
    ...
    <el-dialog title="Assign Purchaser" :visible.sync="caigoudialogVisible" width="30%">
      <el-select v-model="userId" filterable placeholder="Please select">
        <el-option
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="assignUser">Confirm</el-button>
      </span>
    </el-dialog>
  </div>
</template>
